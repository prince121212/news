...
const ColumnLabels: Record<string, Record<string, string>> = {
  ...
  news_item: { id: "ID", source_id: "信源", collector_source_id: "获取源", tag: "标签", original_id: "原始ID", title: "标题", url: "链接", mobile_url: "移动端链接", summary: "摘要", content: "正文", cover_url: "封面", video_url: "视频", pub_date: "发布时间", fetched_at: "抓取时间", updated_at: "更新时间", raw_extra: "扩展数据" },
}
